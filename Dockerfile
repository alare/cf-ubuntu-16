...
RUN wget -nc https://developer.nvidia.com/compute/cuda/8.0/prod/local_installers/cuda-repo-ubuntu1604-8-0-local_8.0.44-1_amd64-deb -O cuda.deb && dpkg -i cuda.deb && apt-get -y update && apt-get install -y cuda
